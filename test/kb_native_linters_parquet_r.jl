@testset "KB native linters (.parquet + R)" begin
    @testset "test_config.toml linters" begin
        ...
        DATA_PATHS = [
            ...
            joinpath(TEST_PATH, "data", "correlated_target_data.parquet"),
            joinpath(TEST_PATH, "data", "imbalanced_data.parquet"),
            joinpath(TEST_PATH, "data", "data.parquet"),
        ]
        CODE_PATHS = [
